...
public class DSPacketFactory {
    ...
    private final int CONTROL_DISABLED = 0x0,
                        CONTROL_TELEOP = 0x4,
                        CONTROL_TEST = 0x5,
                        CONTROL_AUTO = 0x6,
                        CONTROL_ESTOP = 0x80;

    private final int STATUS_OK = 0x10,
                        STATUS_NO_CODE = 0x14,
                        STATUS_REBOOTING = 0x18;

    private final int POSITION_RED1 = 0,
                        POSITION_RED2 = 1,
                        POSITION_RED3 = 2,
                        POSITION_BLUE1 = 3,
                        POSITION_BLUE2 = 4,
    ...
    private final int POS_PACKET_INDEX = 0, POS_CONTROL_BYTE = 3, POS_ROBOT_STATUS = 4;

    private volatile ArrayList<Axis> axisList = new ArrayList<Axis>();
    private volatile ArrayList<ButtonSymbol> buttonList = new ArrayList<ButtonSymbol>();
    ...
    private final int JOY_POS_BYTE_COUNT = 0x0,
